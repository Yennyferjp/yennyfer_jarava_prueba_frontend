                ...
                <li className={styles.submenuItem}>
                  ...
                  {subSubMenuVisible && (
                    <ul className={styles.subsubmenu}>
                      <li className={styles.submenuItem}><a href="#">Item 1</a></li>
                      <li className={styles.submenuItem}><a href="#">Item 2</a></li>
                      <li className={styles.submenuItem}><a href="#">Item 3</a></li>
                    </ul>
                  )}
                </li>
              </ul>
